import  "../App.css"
function Footer(){
    return <footer class="bg-[black] text-white rounded-t-[5%]">
        <div className="f1 p-3 md:flex justify-center items-center text-center border-[#454041] border-b h-[100px]">
                <h1 class="md:text-[1.3vw] text-[4vw] font-bold mb-1">Building your tech skills has never been easier.</h1>
                <button class="bg-[red] text-white p-2 rounded-lg ms-3 xl:w-[170px]">START LEARNING</button>
        </div>
        <div className="f2 xl:flex justify-between items-center md:w-[80%] m-[auto] p-3 border-[#454041] border-b">
        <div className="logo h-full flex justify-center items-center">
            ...
            <div className="icon flex itens-center h-full">
                ...
                <i class="fa-brands fa-x-twitter text-[#808080] ms-2 md:ms-5 text-[22px]"></i>
                <i class="fa-brands fa-facebook text-[#808080] ms-2 md:ms-5 text-[22px]"></i>
                <i class="fa-brands fa-linkedin text-[#808080] ms-2 md:ms-5 text-[22px]"></i>
                <i class="fa-brands fa-instagram text-[#808080] ms-2 md:ms-5 text-[22px]"></i>
                <i class="fa-brands fa-github text-[#808080] ms-2 md:ms-5 text-[22px]"></i>
                <i class="fa-brands fa-youtube text-[#808080] ms-2 md:ms-5 text-[22px]"></i>
            </div>
        </div>
        <div className="f3 md:w-[80%] m-[auto] grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
